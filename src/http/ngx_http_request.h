...
struct ngx_http_request_s {
	...
	u_char							 cache_md5[16];		//md5 cache
	int								 cache_hash_index;	//find from hash index
	ngx_uint_t						 cache_hash_key;	//has been Suspend
	ngx_uint_t						 cache_file_size;	//cache file size
